FROM debian:stable
MAINTAINER Julien Jehannet "julien@smaf.org"
...
RUN echo 'export PULSE_LATENCY_MSEC=60"' >> /usr/local/bin/skype-pulseaudio
RUN echo 'skype' >> /usr/local/bin/skype-pulseaudio
